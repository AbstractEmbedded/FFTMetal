...
@interface MetalGaussianBlurFilter ()
{
}
...
@implementation MetalGaussianBlurFilter
...
- (instancetype)initWithRadius:(float)radius context:(MetalGPGPUContext *)context
{
